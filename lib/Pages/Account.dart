                ...
                children: [
                  Column(
                    children: [
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    Color.fromARGB(255, 230, 240, 233),
                      ...
                      SizedBox(height: 10.h),
                      FutureBuilder(
                        future: authservice.CountCountries(),
                        builder: (context,snapshot){
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            final countryCount = snapshot.data ?? 0;
                            travelStats[1]['count'] = countryCount;
                            return  Padding(
                      ...
                      SizedBox(height: 10.h),
                      FutureBuilder(
                          future: authservice.GetTarvelInfoForJournal(),
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                                ConnectionState.waiting) {
                              return CircularProgressIndicator(color: Colors.black,);
